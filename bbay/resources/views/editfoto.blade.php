        ...
        <nav id="sidebar" aria-label="Main Navigation">
            ...
            <div class="content-side content-side-full">
                <ul class="nav-main">
                    ...
                    <li class="nav-main-heading">Dokumentasi Kegiatan</li>
            ...
            <div class="content">
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-md-8">
                            <h2>Edit Foto Dokumentasi Kegiatan Fiqih Untuk Pemula</h2>
                            <form action="{{route('edit.foto.post', ['id' => $foto_aktifitas->id])}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="form-group">
                                    <label for="nama">Nama Kegiatan :</label>
                                    <input type="text" class="form-control" id="nama" name="nama" value="{{isset($foto_aktifitas->nama)?$foto_aktifitas->nama:''}}">
                                    @error('nama')
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="file" class="form-control" id="photo" name="photo" value="{{isset($foto_aktifitas->photo)?$foto_aktifitas->photo:''}}">
                                    @error('photo')
                                    <div class="alert alert-danger">{{ $message }}
                                    </div>
                                    @enderror
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="description" id="description" value="{{isset($foto_aktifitas->description)?$foto_aktifitas->description:''}}">
                                    @error('description')
                                    <div class="alert alert-danger">{{ $message }}
                                    </div>
                                    @enderror
