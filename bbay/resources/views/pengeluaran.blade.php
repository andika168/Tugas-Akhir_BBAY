...
<head>
    ...
    <title>Admin | Tambah Data Pengeluaran BBAY</title>
            ...
            <div class="content">
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-md-8">
                            <h2>
                                Form Tambah Laporan Pengeluaran
                            </h2>
                            @session('error_input_pengeluaran')
                            <div class="alert alert-danger alert-dismissible fade show" role="alert">
                                {{$value}}
                            </div>
                            @endsession
                            <form action="{{route('tambah_pengeluaran')}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="form-group">
                                    <label for="nama">Nama: </label>
                                    <input type="text" value="{{ old('nama') }}" class="form-control" id="nama" name="nama" placeholder="Nama Penanggung jawab">
                                    @error('nama')
                                ...
                                <div>
                                    ...
                                    <input type="number" value="{{ old('jumlah') }}" class="form-control" id="jumlah" name="jumlah" required placeholder="Masukkan Jumlah">
                                    @error('jumlah')
                                    <div class="alert alert-danger">{{ $message }}
                                    </div>
                                    @enderror
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="file" class="form-control" id="foto_bukti_transaksi" name="bukti" accept="image/*" required>
                                    @error('bukti')
                                    <div class="alert alert-danger">{{ $message }}
                                    </div>
                                    @enderror
