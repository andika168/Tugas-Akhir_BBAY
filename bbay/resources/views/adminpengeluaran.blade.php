...
<head>
    ...
    <title>Admin | Laporan Pengeluaran</title>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{route('keuangan_canceled',['id'=>$item->id])}}"> <button class="button-cross" data-toggle="tooltip" data-placement="auto" title="REJECT">
                                        &#10006;
                                    </button>
                                </a>
                                @endif
