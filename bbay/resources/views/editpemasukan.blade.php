...
<head>
    ...
    <title>Admin | Edit Pemasukan BBAY</title>
                ...
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-md-8">
                            ...
                            <img src="{{asset($data->bukti)}}" alt="ini bukti" class=" img-fluid " width="250px">
                            <form action="{{route('update_pemasukan_save',['id'=>$data->id])}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="form-group">
                                    <label for="nama">Nama: </label>
                                    <input type="text" disabled value="{{ isset($data->nama)?$data->nama:'' }}" class="form-control" id="nama" name="nama" placeholder="Nama Penanggung jawab">
                                    @error('nama')
                                ...
                                <div>
                                    ...
                                    <input type="number" value="{{ isset($data->jumlah)?$data->jumlah:'' }}" class="form-control" id="jumlah" name="jumlah" required placeholder="Masukkan Jumlah" min="0">
                                    @error('jumlah')
                                    <div class="alert alert-danger">{{ $message }}
                                    </div>
                                    @enderror
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="keterangan" disabled class="form-control" rows="5">{{isset($data->keterangan)?$data->keterangan:'' }}</textarea>
                                    @error('keterangan')
                                    <div class="alert alert-danger">{{ $message }}
                                    </div>
                                    @enderror
                                ...
                                <div class="form-group">
                                    <label for="deskripsi">Catatan Perubahan:</label>
                                    <textarea name="remarks" class="form-control" rows="5">{{isset($data->remarks)?$data->remarks:'' }}</textarea>
                                    @error('remarks')
                                    <div class="alert alert-danger">{{ $message }}
                                    </div>
                                    @enderror
